...
public class Beat extends JFrame{
	...
	public Beat() {
		...
		playTrackList.add(new PlayTrack("GameBack2.png","GameBack2.png",
										"play5Highright.mp3","play5.mp3","Fond Adieu - Galdive"));
		playTrackList.add(new PlayTrack("GameBack3.png","GameBack3.png",
										"play4Highright.mp3","play4.mp3","hey -guccihighwaters"));
		playTrackList.add(new PlayTrack("GameBack4.png","GameBack4.png",
										"play3Highright.mp3","play3.mp3","Got My Wings - Fudasca"));
	...
	public void gameStart(int nowSelected , String difficulty) {
		if (selectedMusic != null)
			...
			isGameScreen = true;
			setFocusable(true);
			game = new Game(playTrackList.get(nowSelected).getTitleName(),difficulty);
	}
