...
//최종목표 : xml을 들여서 , 실제 쿼리문을 수행해주는 객체인 SqlSession을 얻기 위함
//이 클래스는 특히 new할때마다 인스턴스가 생성될 것이고, 그렇게되면 SqlSessionFactory로
//다수가 메모리에 올라오므로 , 메모리누수가될것임    ==> 해결책 ) 싱글톤으로 정의하자
...
public class MybatisConfigManager {
	...
	private static MybatisConfigManager instance; //전세계 개발자들이 instance를 사용하여 싱글턴이라는 표현을 줌
